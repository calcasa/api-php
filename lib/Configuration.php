...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://api.calcasa.nl/api/v1';
     ...
     * @var string
     */
    protected $userAgent = 'Calcasa PHP Api Client/1.6.0-beta3';
    ...
    public static function toDebugReport()
    {
        ...
        $report .= '    The version of the OpenAPI document: 1.6.0-beta3' . PHP_EOL;
