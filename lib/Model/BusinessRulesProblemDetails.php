...
class BusinessRulesProblemDetails implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     *
     * @param \Calcasa\Api\Model\BusinessRulesCode|null $businessRulesCode businessRulesCode
     *
     * @return self
     */
    public function setBusinessRulesCode($businessRulesCode)
    {
        if (is_null($businessRulesCode)) {
            throw new \InvalidArgumentException('non-nullable businessRulesCode cannot be null');
        }
