...
/**
 * AdresInfoNotities Class Doc Comment
 *
 * @category Class
 * @description Informatie over de adres zoekopdracht en eventueel gecorrigeerde velden.
 * @package  Calcasa\Api
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class AdresInfoNotities implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AdresInfo_notities';
