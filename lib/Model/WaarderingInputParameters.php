...
class WaarderingInputParameters implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     *
     * @param int|null $hypotheekwaarde Verplicht voor de producttypen `modelwaardeDesktopTaxatie` en `desktopTaxatie`.  In hele euros.
     *
     * @return self
     */
     ...
     *
     * @param bool|null $is_bestaande_nhg_hypotheek Optioneel te gebruiken voor de producttypen `modelwaardeDesktopTaxatie` en `desktopTaxatie`.  Geeft aan of er bij de eventuele bestaande hypotheek gebruik is gemaakt van de Nationale Hypotheekgarantie.
     *
     * @return self
     */
