...
class WaarderingInputParameters implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     *
     * @param int|null $hypotheekwaarde In hele euros.
     *
     * @return self
     */
     ...
     *
     * @param KlantwaardeType|null $klantwaarde_type | Waarde | Omschrijving | | --- | --- | | `onbekend` |  | | `koopsom` |  | | `taxatiewaarde` |  | | `wozWaarde` |  | | `eigenWaardeinschatting` |  |
     *
     * @return self
     */
     ...
     * Sets peildatum
     *
     * @param \DateTime|null $peildatum Peildatum voor de aanvraag. Standaard de datum van vandaag.
     *
     * @return self
     */
