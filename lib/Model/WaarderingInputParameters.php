...
class WaarderingInputParameters implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('aanvraagdoel', $data ?? [], Aanvraagdoel::ONBEKEND);
        $this->setIfExists('klantwaarde', $data ?? [], null);
        $this->setIfExists('klantwaardeType', $data ?? [], KlantwaardeType::ONBEKEND);
     ...
     *
     * @param string|null $geldverstrekker Ongebruikt voor de meeste client typen op dit moment. Deze informatie komt uit de credentials. Als dit veld wel verplicht is dan is dit gecommuniceerd.
     *
     * @return self
     */
     ...
     *
     * @param int|null $benodigdeOverbrugging Verplicht voor de combinatie van de producttypen `modelwaardeDesktopTaxatie`, `desktopTaxatie` en `desktopTaxatiePlus` en het aanvraagdoel `overbruggingsfinanciering`. In hele euros.
     *
     * @return self
     */
