...
/**
 * OmgevingsdataWijk Class Doc Comment
 *
 * @category Class
 * @description Statistieken op wijk-niveau.
 * @package  Calcasa\Api
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class OmgevingsdataWijk implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Omgevingsdata_wijk';
