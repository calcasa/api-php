...
/**
 * OmgevingsdataBuurt Class Doc Comment
 *
 * @category Class
 * @description Statistieken op buurt-niveau.
 * @package  Calcasa\Api
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class OmgevingsdataBuurt implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Omgevingsdata_buurt';
