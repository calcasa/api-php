...
class Modeldata implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static array $openAPINullables = [
        'marktwaarde' => false,
        'marktwaardeOndergrens' => false,
        'marktwaardeBovengrens' => false,
        'confidenceLevel' => false,
        'waardebepalingsdatum' => false,
        'executiewaarde' => false
    ];
    ...
    {
        $this->setIfExists('marktwaarde', $data ?? [], null);
        $this->setIfExists('marktwaardeOndergrens', $data ?? [], null);
        $this->setIfExists('marktwaardeBovengrens', $data ?? [], null);
        $this->setIfExists('confidenceLevel', $data ?? [], null);
        $this->setIfExists('waardebepalingsdatum', $data ?? [], null);
        $this->setIfExists('executiewaarde', $data ?? [], null);
    }
    ...
    */
    ...
    {
        if (is_null($marktwaarde)) {
            throw new \InvalidArgumentException('non-nullable marktwaarde cannot be null');
        }
    ...
    {
        if (is_null($marktwaardeOndergrens)) {
            throw new \InvalidArgumentException('non-nullable marktwaardeOndergrens cannot be null');
        }
    ...
    {
        if (is_null($marktwaardeBovengrens)) {
            throw new \InvalidArgumentException('non-nullable marktwaardeBovengrens cannot be null');
        }
    ...
    {
        if (is_null($confidenceLevel)) {
            throw new \InvalidArgumentException('non-nullable confidenceLevel cannot be null');
        }
     ...
     *
     * @param \DateTime|null $waardebepalingsdatum waardebepalingsdatum
     *
     * @return self
     */
    public function setWaardebepalingsdatum($waardebepalingsdatum)
    {
        if (is_null($waardebepalingsdatum)) {
            throw new \InvalidArgumentException('non-nullable waardebepalingsdatum cannot be null');
        }
    ...
    {
        if (is_null($executiewaarde)) {
            throw new \InvalidArgumentException('non-nullable executiewaarde cannot be null');
        }
