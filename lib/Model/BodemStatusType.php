...
class BodemStatusType
{
     ...
     */
    public const GEEN_DATA = 'geenData';

    public const ONBEKEND = 'onbekend';

    public const NIET_VERVUILD = 'nietVervuild';

    public const NIET_ERNSTIG = 'nietErnstig';

    public const POTENTIEEL_ERNSTIG = 'potentieelErnstig';

    public const ERNSTIG = 'ernstig';
