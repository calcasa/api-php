...
class WaarderingZoekParameters implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('waarderingStatus', $data ?? [], null);
    ...
    */
    ...
    public function setAangemaakt($aangemaakt)
    {
        if (is_null($aangemaakt)) {
            array_push($this->openAPINullablesSetToNull, 'aangemaakt');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('aangemaakt', $nullablesSetToNull);
            if ($index !== FALSE) {
    ...
    public function setAanvraagdoel($aanvraagdoel)
    {
        if (is_null($aanvraagdoel)) {
            array_push($this->openAPINullablesSetToNull, 'aanvraagdoel');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('aanvraagdoel', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     *
     * @param \Calcasa\Api\Model\WaarderingStatus|null $waarderingStatus waarderingStatus
     *
     * @return self
     */
    public function setWaarderingStatus($waarderingStatus)
    {
        if (is_null($waarderingStatus)) {
            array_push($this->openAPINullablesSetToNull, 'waarderingStatus');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('waarderingStatus', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
