...
class AdresInfo implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('notities', $data ?? [], null);
        $this->setIfExists('adresGevonden', $data ?? [], null);
    }
    ...
    */
     ...
     *
     * @param int $bagNummeraanduidingId Het BAG nummeraanduiding Id van het adres. Normaal aangevuld met nullen tot 16 karakters.
     *
     * @return self
     */
    ...
    {
        if (is_null($notities)) {
            throw new \InvalidArgumentException('non-nullable notities cannot be null');
        }
    ...
    {
        if (is_null($adresGevonden)) {
            array_push($this->openAPINullablesSetToNull, 'adresGevonden');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('adresGevonden', $nullablesSetToNull);
            if ($index !== FALSE) {
