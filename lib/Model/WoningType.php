...
class WoningType
{
    ...
    const VRIJSTAAND = 'vrijstaand';

    const HALF_VRIJSTAAND = 'halfVrijstaand';

    const HOEKWONING = 'hoekwoning';

    const TUSSENWONING = 'tussenwoning';

    const GALERIJFLAT = 'galerijflat';

    const PORTIEKFLAT = 'portiekflat';

    const MAISONNETTE = 'maisonnette';

    const BOVENWONING = 'bovenwoning';

    const BENEDENWONING = 'benedenwoning';
