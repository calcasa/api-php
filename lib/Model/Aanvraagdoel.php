...
class Aanvraagdoel
{
    ...
    public const AANKOOP_NIEUWE_WONING = 'aankoopNieuweWoning';

    public const OVERBRUGGINGSFINANCIERING = 'overbruggingsfinanciering';

    public const HYPOTHEEK_OVERSLUITEN = 'hypotheekOversluiten';

    public const HYPOTHEEK_OPHOGEN = 'hypotheekOphogen';

    public const HYPOTHEEK_WIJZIGING = 'hypotheekWijziging';

    public const HYPOTHEEKRENTE_WIJZIGEN = 'hypotheekrenteWijzigen';
