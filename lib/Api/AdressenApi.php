...
class AdressenApi
{
     ...
     * @return \Calcasa\Api\Model\AdresInfo|\Calcasa\Api\Model\UnauthorizedProblemDetails|\Calcasa\Api\Model\PermissionsDeniedProblemDetails|\Calcasa\Api\Model\NotFoundProblemDetails|\Calcasa\Api\Model\ProblemDetails
     */
    public function searchAdres($adres)
    {
     ...
     * @return array of \Calcasa\Api\Model\AdresInfo|\Calcasa\Api\Model\UnauthorizedProblemDetails|\Calcasa\Api\Model\PermissionsDeniedProblemDetails|\Calcasa\Api\Model\NotFoundProblemDetails|\Calcasa\Api\Model\ProblemDetails, HTTP status code, HTTP response headers (array of strings)
     */
    public function searchAdresWithHttpInfo($adres)
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function searchAdresAsync($adres)
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function searchAdresAsyncWithHttpInfo($adres)
    {
        $returnType = '\Calcasa\Api\Model\AdresInfo';
        $request = $this->searchAdresRequest($adres);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function searchAdresRequest($adres)
    {
