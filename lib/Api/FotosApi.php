...
class FotosApi
{
    ...
    {
        list($response) = $this->getFotoWithHttpInfo($id);
        return $response;
    }
     ...
     */
    public function getFotoWithHttpInfo($id)
    {
        $request = $this->getFotoRequest($id);
     ...
     */
    public function getFotoAsync($id)
    {
        return $this->getFotoAsyncWithHttpInfo($id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getFotoAsyncWithHttpInfo($id)
    {
        $returnType = '\SplFileObject';
        $request = $this->getFotoRequest($id);
     ...
     */
    public function getFotoRequest($id)
    {
