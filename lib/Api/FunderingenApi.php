...
class FunderingenApi
{
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getFunderingById'] to see the possible values for this operation
     *
     ...
     * @deprecated
     */
    public function getFunderingById($bagNummeraanduidingId, string $contentType = self::contentTypes['getFunderingById'][0])
    {
        list($response) = $this->getFunderingByIdWithHttpInfo($bagNummeraanduidingId, $contentType);
        return $response;
    }
     ...
     * @deprecated
     */
    public function getFunderingByIdWithHttpInfo($bagNummeraanduidingId, string $contentType = self::contentTypes['getFunderingById'][0])
    {
        $request = $this->getFunderingByIdRequest($bagNummeraanduidingId, $contentType);
     ...
     * @deprecated
     */
    public function getFunderingByIdAsync($bagNummeraanduidingId, string $contentType = self::contentTypes['getFunderingById'][0])
    {
        return $this->getFunderingByIdAsyncWithHttpInfo($bagNummeraanduidingId, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @deprecated
     */
    public function getFunderingByIdAsyncWithHttpInfo($bagNummeraanduidingId, string $contentType = self::contentTypes['getFunderingById'][0])
    {
     ...
     * @deprecated
     */
    public function getFunderingByIdRequest($bagNummeraanduidingId, string $contentType = self::contentTypes['getFunderingById'][0])
    {
