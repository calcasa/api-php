...
class BuurtApi
{
     ...
     */
    public function getBuurt($buurtCode)
    {
        list($response) = $this->getBuurtWithHttpInfo($buurtCode);
        return $response;
    }
     ...
     */
    public function getBuurtWithHttpInfo($buurtCode)
    {
        $request = $this->getBuurtRequest($buurtCode);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Calcasa\Api\Model\Omgevingsdata' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Calcasa\Api\Model\Omgevingsdata' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\Calcasa\Api\Model\Omgevingsdata', []),
     ...
     */
    public function getBuurtAsync($buurtCode)
    {
        return $this->getBuurtAsyncWithHttpInfo($buurtCode)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getBuurtAsyncWithHttpInfo($buurtCode)
    {
        $returnType = '\Calcasa\Api\Model\Omgevingsdata';
        $request = $this->getBuurtRequest($buurtCode);
     ...
     */
    public function getBuurtRequest($buurtCode)
    {
