...
class BuurtApi
{
     ...
     *
     * @param  int $buurtId Een CBS buurt ID. (required)
     *
     ...
     */
    public function getBuurt($buurtId)
    {
        list($response) = $this->getBuurtWithHttpInfo($buurtId);
        return $response;
    }
     ...
     */
    public function getBuurtWithHttpInfo($buurtId)
    {
        $request = $this->getBuurtRequest($buurtId);
     ...
     */
    public function getBuurtAsync($buurtId)
    {
        return $this->getBuurtAsyncWithHttpInfo($buurtId)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getBuurtAsyncWithHttpInfo($buurtId)
    {
        $returnType = '\Calcasa\Api\Model\Omgevingsdata';
        $request = $this->getBuurtRequest($buurtId);
     ...
     */
    public function getBuurtRequest($buurtId)
    {
        // verify the required parameter 'buurtId' is set
        if ($buurtId === null || (is_array($buurtId) && count($buurtId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $buurtId when calling getBuurt'
            );
        }

        $resourcePath = '/api/v1/buurt/{buurtId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        if ($buurtId !== null) {
            $resourcePath = str_replace(
                '{' . 'buurtId' . '}',
                ObjectSerializer::toPathValue($buurtId),
                $resourcePath
            );
        }
