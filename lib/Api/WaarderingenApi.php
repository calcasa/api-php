...
class WaarderingenApi
{
     ...
     *
     * @param  \Calcasa\Api\Model\WaarderingInputParameters $waarderingInputParameters waarderingInputParameters (optional)
     *
     ...
     */
    public function createWaardering($waarderingInputParameters = null)
    {
     ...
     * Creërt een waardering.
     *
     * @param  \Calcasa\Api\Model\WaarderingInputParameters $waarderingInputParameters (optional)
     *
     * @throws \Calcasa\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     */
    public function createWaarderingWithHttpInfo($waarderingInputParameters = null)
    {
     ...
     */
    public function createWaarderingAsync($waarderingInputParameters = null)
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createWaarderingAsyncWithHttpInfo($waarderingInputParameters = null)
    {
        $returnType = '\Calcasa\Api\Model\Waardering';
        $request = $this->createWaarderingRequest($waarderingInputParameters);
     ...
     */
    public function createWaarderingRequest($waarderingInputParameters = null)
    {

        $resourcePath = '/api/v1/waarderingen';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    public function getWaarderingRequest($id)
    {
        ...
        $resourcePath = '/api/v1/waarderingen/{id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    public function getWaarderingOntwikkelingRequest($id)
    {
        ...
        $resourcePath = '/api/v1/waarderingen/{id}/ontwikkeling';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     *
     * @param  string $id De waardering Id in de vorm van een UUID. (required)
     * @param  \Calcasa\Api\Model\JsonPatchDocument $jsonPatchDocument Het JsonPatch document voor de operatie. (optional)
     *
     * @throws \Calcasa\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Calcasa\Api\Model\InvalidArgumentProblemDetails|\Calcasa\Api\Model\NotFoundProblemDetails|\Calcasa\Api\Model\PermissionsDeniedProblemDetails|\Calcasa\Api\Model\ProblemDetails|\Calcasa\Api\Model\ResourceExhaustedProblemDetails|\Calcasa\Api\Model\ValidationProblemDetails|\Calcasa\Api\Model\Waardering
     */
    public function patchWaarderingen($id, $jsonPatchDocument = null)
    {
     ...
     * @throws \Calcasa\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Calcasa\Api\Model\InvalidArgumentProblemDetails|\Calcasa\Api\Model\NotFoundProblemDetails|\Calcasa\Api\Model\PermissionsDeniedProblemDetails|\Calcasa\Api\Model\ProblemDetails|\Calcasa\Api\Model\ResourceExhaustedProblemDetails|\Calcasa\Api\Model\ValidationProblemDetails|\Calcasa\Api\Model\Waardering, HTTP status code, HTTP response headers (array of strings)
     */
    public function patchWaarderingenWithHttpInfo($id, $jsonPatchDocument = null)
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function patchWaarderingenAsync($id, $jsonPatchDocument = null)
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function patchWaarderingenAsyncWithHttpInfo($id, $jsonPatchDocument = null)
    {
        $returnType = '\Calcasa\Api\Model\Waardering';
        $request = $this->patchWaarderingenRequest($id, $jsonPatchDocument);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function patchWaarderingenRequest($id, $jsonPatchDocument = null)
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     *
     * @param  \Calcasa\Api\Model\WaarderingZoekParameters $waarderingZoekParameters De parameters voor deze zoekopdracht. (optional)
     *
     * @throws \Calcasa\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     */
    public function searchWaarderingen($waarderingZoekParameters = null)
    {
     ...
     */
    public function searchWaarderingenWithHttpInfo($waarderingZoekParameters = null)
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function searchWaarderingenAsync($waarderingZoekParameters = null)
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function searchWaarderingenAsyncWithHttpInfo($waarderingZoekParameters = null)
    {
        $returnType = '\Calcasa\Api\Model\Waardering[]';
        $request = $this->searchWaarderingenRequest($waarderingZoekParameters);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function searchWaarderingenRequest($waarderingZoekParameters = null)
    {

        $resourcePath = '/api/v1/waarderingen/zoeken';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
