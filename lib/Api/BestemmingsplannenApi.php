...
class BestemmingsplannenApi
{
     ...
     */
    public function getBestemmingById($bagNummeraanduidingId)
    {
        list($response) = $this->getBestemmingByIdWithHttpInfo($bagNummeraanduidingId);
        return $response;
    }
     ...
     */
    public function getBestemmingByIdWithHttpInfo($bagNummeraanduidingId)
    {
        $request = $this->getBestemmingByIdRequest($bagNummeraanduidingId);
            ...
            switch($statusCode) {
                case 200:
                    if ('\Calcasa\Api\Model\Bestemmingsdata' === '\SplFileObject') {
                        ...
                        if ('\Calcasa\Api\Model\Bestemmingsdata' !== 'string') {
     ...
     */
    public function getBestemmingByIdAsync($bagNummeraanduidingId)
    {
        return $this->getBestemmingByIdAsyncWithHttpInfo($bagNummeraanduidingId)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getBestemmingByIdAsyncWithHttpInfo($bagNummeraanduidingId)
    {
        $returnType = '\Calcasa\Api\Model\Bestemmingsdata';
        $request = $this->getBestemmingByIdRequest($bagNummeraanduidingId);
     ...
     */
    public function getBestemmingByIdRequest($bagNummeraanduidingId)
    {
